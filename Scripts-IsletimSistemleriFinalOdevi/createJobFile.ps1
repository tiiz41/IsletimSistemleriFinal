<# Bir alt satırdaki kodu tek başınada çalıştırın #>
...
<# 
 ...
 Eger size gonderdigimiz "Scripts-IsletimSistemleriFinalOdevi" adli klasor masaustunde degilse bu klasoru masaustune almayi ve asagidaki -Argument kisminde Scriptimizin yolunda bulunan "Batın" yazisini kendi user name'nize gore degistirmenizi
 rica ederiz.  
...
$action = New-ScheduledTaskAction -Execute 'Powershell.exe'  -Argument 'C:\Users\Batın\Desktop\Scripts-IsletimSistemleriFinalOdevi\algoritma1.ps1'
...
$action = New-ScheduledTaskAction -Execute 'Powershell.exe'  -Argument 'C:\Users\Batın\Desktop\Scripts-IsletimSistemleriFinalOdevi\algoritma2.ps1'
